  ...
  <div id="sidebar">
    <div class="sidebar-con">
      <div class="login">
        ...
        <div class="icons">
          <div class="addNote">
            <i class="el-icon-plus" @click="onaddNote"></i>
          </div>
          <router-link to="/note" title="笔记"
            ><i class="note el-icon-s-order show" @click="note"></i
          ></router-link>
          <router-link to="/note" title="文件夹"
            ><i class="book el-icon-s-platform" @click="book"></i
          ></router-link>
...
export default {
  ...
  inject: ["reload"],
  methods: {
    ...mapActions(["addNote", "addNotebook", "deleteNotebook"]),
    ...
    note() {
      ...
      if (this.$store.bookappear) {
        document
          .querySelector("#note-detail #booklist")
